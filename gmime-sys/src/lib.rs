...
// from gir-files (https://github.com/gtk-rs/gir-files @ ebb0385)
// DO NOT EDIT
...
// Constants
pub const GMIME_BINARY_AGE: c_int = 207;
...
pub const GMIME_INTERFACE_AGE: c_int = 1;
pub const GMIME_MAJOR_VERSION: c_int = 3;
pub const GMIME_MICRO_VERSION: c_int = 7;
