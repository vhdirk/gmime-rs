...
impl fmt::Display for CipherAlgo {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "CipherAlgo::{}", match *self {
            CipherAlgo::Default => "Default",
            CipherAlgo::Idea => "Idea",
            CipherAlgo::_3des => "_3des",
            ...
            CipherAlgo::Camellia128 => "Camellia128",
            CipherAlgo::Camellia192 => "Camellia192",
            CipherAlgo::Camellia256 => "Camellia256",
            _ => "Unknown",
        })
    }
}
...
impl ToGlib for CipherAlgo {
    type GlibType = gmime_sys::GMimeCipherAlgo;

    fn to_glib(&self) -> gmime_sys::GMimeCipherAlgo {
        match *self {
            CipherAlgo::Default => gmime_sys::GMIME_CIPHER_ALGO_DEFAULT,
            CipherAlgo::Idea => gmime_sys::GMIME_CIPHER_ALGO_IDEA,
            CipherAlgo::_3des => gmime_sys::GMIME_CIPHER_ALGO_3DES,
            CipherAlgo::Cast5 => gmime_sys::GMIME_CIPHER_ALGO_CAST5,
            CipherAlgo::Blowfish => gmime_sys::GMIME_CIPHER_ALGO_BLOWFISH,
            CipherAlgo::Aes => gmime_sys::GMIME_CIPHER_ALGO_AES,
            CipherAlgo::Aes192 => gmime_sys::GMIME_CIPHER_ALGO_AES192,
            CipherAlgo::Aes256 => gmime_sys::GMIME_CIPHER_ALGO_AES256,
            CipherAlgo::Twofish => gmime_sys::GMIME_CIPHER_ALGO_TWOFISH,
            CipherAlgo::Camellia128 => gmime_sys::GMIME_CIPHER_ALGO_CAMELLIA128,
            CipherAlgo::Camellia192 => gmime_sys::GMIME_CIPHER_ALGO_CAMELLIA192,
            CipherAlgo::Camellia256 => gmime_sys::GMIME_CIPHER_ALGO_CAMELLIA256,
...
#[doc(hidden)]
impl FromGlib<gmime_sys::GMimeCipherAlgo> for CipherAlgo {
    fn from_glib(value: gmime_sys::GMimeCipherAlgo) -> Self {
        match value {
...
impl fmt::Display for ParserWarning {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ParserWarning::{}", match *self {
            ParserWarning::WarnDuplicatedHeader => "WarnDuplicatedHeader",
            ParserWarning::WarnDuplicatedParameter => "WarnDuplicatedParameter",
            ParserWarning::WarnUnencoded8bitHeader => "WarnUnencoded8bitHeader",
            ParserWarning::WarnInvalidContentType => "WarnInvalidContentType",
            ParserWarning::WarnInvalidRfc2047HeaderValue => "WarnInvalidRfc2047HeaderValue",
            ParserWarning::WarnMalformedMultipart => "WarnMalformedMultipart",
            ParserWarning::WarnTruncatedMessage => "WarnTruncatedMessage",
            ParserWarning::WarnMalformedMessage => "WarnMalformedMessage",
            ParserWarning::CritInvalidHeaderName => "CritInvalidHeaderName",
            ParserWarning::CritConflictingHeader => "CritConflictingHeader",
            ParserWarning::CritConflictingParameter => "CritConflictingParameter",
            ParserWarning::CritMultipartWithoutBoundary => "CritMultipartWithoutBoundary",
            ParserWarning::WarnInvalidParameter => "WarnInvalidParameter",
            ParserWarning::WarnInvalidAddressList => "WarnInvalidAddressList",
            ParserWarning::CritNestingOverflow => "CritNestingOverflow",
            _ => "Unknown",
        })
    }
}
...
#[doc(hidden)]
impl ToGlib for ParserWarning {
    type GlibType = gmime_sys::GMimeParserWarning;

    fn to_glib(&self) -> gmime_sys::GMimeParserWarning {
        match *self {
            ParserWarning::WarnDuplicatedHeader => gmime_sys::GMIME_WARN_DUPLICATED_HEADER,
            ParserWarning::WarnDuplicatedParameter => gmime_sys::GMIME_WARN_DUPLICATED_PARAMETER,
            ParserWarning::WarnUnencoded8bitHeader => gmime_sys::GMIME_WARN_UNENCODED_8BIT_HEADER,
            ParserWarning::WarnInvalidContentType => gmime_sys::GMIME_WARN_INVALID_CONTENT_TYPE,
            ParserWarning::WarnInvalidRfc2047HeaderValue => gmime_sys::GMIME_WARN_INVALID_RFC2047_HEADER_VALUE,
            ParserWarning::WarnMalformedMultipart => gmime_sys::GMIME_WARN_MALFORMED_MULTIPART,
            ParserWarning::WarnTruncatedMessage => gmime_sys::GMIME_WARN_TRUNCATED_MESSAGE,
            ParserWarning::WarnMalformedMessage => gmime_sys::GMIME_WARN_MALFORMED_MESSAGE,
            ParserWarning::CritInvalidHeaderName => gmime_sys::GMIME_CRIT_INVALID_HEADER_NAME,
            ParserWarning::CritConflictingHeader => gmime_sys::GMIME_CRIT_CONFLICTING_HEADER,
            ParserWarning::CritConflictingParameter => gmime_sys::GMIME_CRIT_CONFLICTING_PARAMETER,
            ParserWarning::CritMultipartWithoutBoundary => gmime_sys::GMIME_CRIT_MULTIPART_WITHOUT_BOUNDARY,
            ParserWarning::WarnInvalidParameter => gmime_sys::GMIME_WARN_INVALID_PARAMETER,
            ParserWarning::WarnInvalidAddressList => gmime_sys::GMIME_WARN_INVALID_ADDRESS_LIST,
            ParserWarning::CritNestingOverflow => gmime_sys::GMIME_CRIT_NESTING_OVERFLOW,
            ParserWarning::__Unknown(value) => value
        }
    }
}

#[doc(hidden)]
impl FromGlib<gmime_sys::GMimeParserWarning> for ParserWarning {
    fn from_glib(value: gmime_sys::GMimeParserWarning) -> Self {
        match value {
            1 => ParserWarning::WarnDuplicatedHeader,
            2 => ParserWarning::WarnDuplicatedParameter,
            3 => ParserWarning::WarnUnencoded8bitHeader,
            4 => ParserWarning::WarnInvalidContentType,
            5 => ParserWarning::WarnInvalidRfc2047HeaderValue,
            6 => ParserWarning::WarnMalformedMultipart,
            7 => ParserWarning::WarnTruncatedMessage,
            8 => ParserWarning::WarnMalformedMessage,
            9 => ParserWarning::CritInvalidHeaderName,
            10 => ParserWarning::CritConflictingHeader,
            11 => ParserWarning::CritConflictingParameter,
            12 => ParserWarning::CritMultipartWithoutBoundary,
            13 => ParserWarning::WarnInvalidParameter,
            14 => ParserWarning::WarnInvalidAddressList,
            15 => ParserWarning::CritNestingOverflow,
            value => ParserWarning::__Unknown(value),
        }
    }
}
