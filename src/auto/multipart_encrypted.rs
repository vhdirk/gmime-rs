...
impl MultipartEncrypted {
    ...
    //pub fn encrypt<P: IsA<CryptoContext>, Q: IsA<Object>>(ctx: &P, entity: &Q, sign: bool, userid: Option<&str>, flags: EncryptFlags, recipients: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 0, id: 28 }) -> Result<Option<MultipartEncrypted>, Error> {
    //    unsafe { TODO: call gmime_sys:g_mime_multipart_encrypted_encrypt() }
    //}
}
