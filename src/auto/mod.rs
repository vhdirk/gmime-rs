...
pub use self::internet_address::{InternetAddress, NONE_INTERNET_ADDRESS};
pub use self::internet_address::InternetAddressExt;

mod internet_address_list;
pub use self::internet_address_list::{InternetAddressList, NONE_INTERNET_ADDRESS_LIST};
pub use self::internet_address_list::InternetAddressListExt;

mod internet_address_mailbox;
pub use self::internet_address_mailbox::{InternetAddressMailbox, NONE_INTERNET_ADDRESS_MAILBOX};
