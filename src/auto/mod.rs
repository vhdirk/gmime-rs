...
mod filter_checksum;
pub use self::filter_checksum::{FilterChecksum, FilterChecksumClass, NONE_FILTER_CHECKSUM};
...
mod gpg_context;
pub use self::gpg_context::{GpgContext, GpgContextClass};
...
pub use self::internet_address_group::{InternetAddressGroup, InternetAddressGroupClass, NONE_INTERNET_ADDRESS_GROUP};
pub use self::internet_address_group::InternetAddressGroupExt;
...
mod pkcs7_context;
pub use self::pkcs7_context::{Pkcs7Context, Pkcs7ContextClass};
...
pub mod traits {
    ...
    pub use super::InternetAddressGroupExt;
