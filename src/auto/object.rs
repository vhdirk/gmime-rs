...
pub trait ObjectExt {
    ...
    //fn get_autocrypt_headers(&self, effective_date: /*Ignored*/&glib::DateTime, matchheader: &str, addresses: /*Ignored*/&InternetAddressList, keep_incomplete: bool) -> /*Ignored*/Option<AutocryptHeaderList>;
